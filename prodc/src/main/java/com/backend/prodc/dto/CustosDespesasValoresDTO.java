...
public class CustosDespesasValoresDTO {
    ...
    public CustosDespesasValoresDTO() {

    }

    public CustosDespesasValoresDTO(Float jan, Float fev, Float mar, Float abr, Float mai, Float jun, Float jul,
            Float ago,
    ...
    public CustosDespesasValoresDTO(CustosDespesasValores entity) {
        this.idCustoDespesa = entity.getIdCustoDespesa();
